...
from managers.auth import is_approver, oauth2_scheme, is_admin
...
@router.put("/users/{user_id}/make-approver", dependencies=[Depends(oauth2_scheme), Depends(is_approver)], status_code=204)
